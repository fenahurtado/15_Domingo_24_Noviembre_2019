...
\hfill \\ \hfill
\input{contenido/1_estructura.tex}
...
{\color{amarillo} \vspace{4pt}}
\hfill \\ \hfill
\input{contenido/3_motivacion.tex}

\newpage
{\noindent \medium{Evangelio}}
{\color{amarillo} \vspace{4pt}}
\hfill \\ \hfill
\input{contenido/4_evangelio.tex}

\hfill \\ \hfill
{\medium{Actividades}}
{\color{amarillo} \vspace{4pt}}
\hfill \\ \hfill
\input{contenido/5_actividades.tex}

\hfill \\ \hfill
{\medium{Propósito Comunitario}}
{\color{amarillo} \vspace{4pt}}
\hfill \\ \hfill
\input{contenido/6_proposito.tex}

\hfill \\ \hfill
{\medium{Oración Final}}
{\color{amarillo} \vspace{4pt}}
\hfill \\ \hfill
\input{contenido/7_oracion_final.tex}
